...
XAUUSD_ORB_CONFIG = V6StrategyConfig(
    ...
    trade_start_hour=8,
    trade_end_hour=16,
    skip_weekdays=(),            # 2026-05-12: Wednesday-skip dropped for proof-of-life validation (adds ~20% more trade-window opportunities while A+B+C1 + Phase 1/2/3 paths are unexercised live). Revert to (2,) once those fixes are confirmed in production — Wednesday was historically a poor edge day for XAUUSD ORB per backtest.
    rr_ratio=2.5,
    min_range_size=1.0,
    max_range_size=15.0,
