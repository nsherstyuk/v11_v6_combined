...
from .models import SignalContext, LLMResponse
from .prompt_templates import SYSTEM_PROMPT, build_signal_prompt
...
class GrokFilter:
    ...
    def _log_conversation(
        ...
        filename = f"{ts}_{context.instrument}_{context.direction}.json"
