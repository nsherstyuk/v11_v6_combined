...
| 2026-05-13 | `docs/journal/2026-05-13_xauusd_first_live_fill_full_lifecycle.md` | **Phase 6 proof-of-life closed.** First fill on Mac paper. Full lifecycle: cron → range → brackets (with DIAG) → fill → SL/TP → market exit at window close. PnL −$7.96 paper, plumbing perfect. The no-fill bug arc is fully resolved |
| 2026-05-15 | `docs/journal/2026-05-15_gbpchf_sma50_cross_research.md` | GBPCHF SMA50-cross research: two pre-registered nulls. ~44-46% cont rate stable across 8 years but too small to clear cost |
| 2026-05-16 | `docs/journal/2026-05-16_usdjpy_orb_preregistered_fail.md` | USDJPY ORB pre-registered run: gate FAIL on OOS 2019-2022 (AvgR -0.019). But year-by-year shows 2022-2025 all 5 years positive (BOJ-normalization regime). 21 years data downloaded |
| 2026-05-18 | `docs/journal/2026-05-18_replay_vs_live_xauusd_divergence.md` | Tick-replay vs live for XAUUSD 2026-05-08→18: 7/8 days match perfectly. 1 divergence root-caused to range-source data (live IBKR-historical vs replay tick-reconstructed). Strategy logic faithful in replay |
| 2026-05-19 | `docs/journal/2026-05-19_first_profitable_live_trade_and_backtest_validates.md` | **First profitable live trade** (SHORT +$20.50 paper) AND **XAUUSD backtest PASSES the gate** on fresh 16yr data. OOS 2018-23 AvgR +0.085, IS 2024-now +0.108. Edge stable since 2018 (7-of-8 positive years). Trade frequency matches historical baseline. **Read this last; live system validates against history** |
